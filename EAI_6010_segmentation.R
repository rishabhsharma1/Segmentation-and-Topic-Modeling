...
setwd ("/Users/rishabhsharma/Desktop/Analytics/Applications of AI/Week 6")
# Check that you are in the right directory

getwd()

list.files("/Users/rishabhsharma/Desktop/Analytics/Applications of AI/Week 6", recursive = TRUE)
...
#Define a file path
file_path_cust <- file.path("/Users/rishabhsharma/Desktop/Analytics/Applications of AI/Week 6", "Customer_Dataset_File.csv")
...
customer_data <- fread("Customer_Dataset_File.csv")
...
cust_data.df.num <- subset(customer_data, select = c("Age",
                                               "Gender_num","HHIncome_2"))

#To check if the column exists in my dataset
c("Age") %in% colnames(customer_data)
c("Gender_num") %in% colnames(customer_data)
c("HHIncome_2") %in% colnames(customer_data)
